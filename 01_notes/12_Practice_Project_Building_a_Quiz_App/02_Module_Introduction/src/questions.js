export default [
   {
      ...
      answers: [
         ...
         'A library for managing state in web application.',
         'A framework to build user interface with help of imperative code.',
         'A library used for building mobile application only.',
      ]
   },
   {
    id: 'q2',
